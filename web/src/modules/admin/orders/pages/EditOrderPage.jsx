          ...
          <Card className="rounded-[3rem] border border-border bg-card shadow-sm overflow-hidden">
            ...
            <CardContent className="p-8 pt-4 space-y-6">
              <div className="space-y-6">
                ...
                <div className="grid gap-2">
                  <Label className="text-[9px] font-black uppercase tracking-widest text-muted-foreground ml-1">Shipping Address</Label>
                  <Textarea 
                    {...register("address", { required: "Address is required" })} 
                    className="bg-muted/30 border border-border rounded-xl p-6 text-xs font-bold focus:ring-2 focus:ring-indigo-600/20 min-h-[100px] resize-none" 
                  />
                  {errors.address && (
                    <span className="text-red-500 text-[10px] font-bold mt-1 ml-1">{errors.address.message}</span>
                  )}
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-8 pt-4 space-y-8">
              <div className="grid gap-3">
                ...
                <select
                  ...
                  className="w-full h-14 bg-[#130F26] text-white border border-border/80 rounded-xl px-6 text-xs font-bold focus:ring-2 focus:ring-indigo-600/20 outline-none cursor-pointer uppercase tracking-widest"
                >
                  <option value="COD" className="text-slate-900 bg-white">Cash On Delivery</option>
                  <option value="cod" className="text-slate-900 bg-white">Cash On Delivery</option>
                  <option value="SSLCommerz" className="text-slate-900 bg-white">SSLCommerz (Online)</option>
                  <option value="sslcommerz" className="text-slate-900 bg-white">SSLCommerz (Online)</option>
                  <option value="bKash" className="text-slate-900 bg-white">bKash (MFS)</option>
                  <option value="bkash" className="text-slate-900 bg-white">bKash (MFS)</option>
                </select>
              </div>
