...
export default function WishlistPage() {
  ...
  const handleAddToCart = async (e, product) => {
    ...
    try {
      await addToCart({ productId: product._id, sizeId: sizeId, quantity: 1 });
  ...
  // Primary Loader
  if (!isMounted || authLoading || wishlistLoading) {
