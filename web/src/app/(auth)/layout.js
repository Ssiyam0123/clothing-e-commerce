    ...
    <div className="min-h-screen grid lg:grid-cols-2 bg-[#fcfcfc] dark:bg-[#050505] transition-colors duration-700">
      ...
      <div className="hidden lg:block relative bg-zinc-900 overflow-hidden">
        ...
        <div className="absolute bottom-20 left-20 z-10">
          ...
          >
            ...
            <p className="text-zinc-400 mt-4 uppercase text-[10px] font-black tracking-[0.4em]">
      ...
      <div className="flex items-center justify-center p-6 sm:p-12 lg:p-20 relative overflow-hidden">
        ...
        <div className="w-full max-w-md relative z-10">
          <Link href="/" className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors mb-12">
            ← Back to Home
          </Link>
          {children}
        </div>
