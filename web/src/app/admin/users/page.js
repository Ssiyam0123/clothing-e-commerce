  ...
  const columns = [
    {
      ...
      render: (item) => (
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-[13px] font-black text-zinc-900 dark:text-zinc-100 leading-none mb-1 uppercase tracking-tight">
              {item.name}
            </p>
    ...
    },
    {
      ...
      render: (item) => (
        <span
          className={`inline-flex items-center px-4 py-1.5 text-[8px] font-black uppercase tracking-[0.2em] rounded-full border ${
            item.role === "admin"
      ...
      render: (item) => (
        <div className="flex items-center gap-2 justify-end">
          <Link
            ...
            className="p-2.5 bg-zinc-100 dark:bg-zinc-900 text-indigo-500 hover:bg-indigo-600 hover:text-white rounded-xl transition-all shadow-sm"
          >
            <svg
          ...
          <button
            ...
            className="p-2.5 bg-zinc-100 dark:bg-zinc-900 text-rose-500 hover:bg-rose-600 hover:text-white rounded-xl transition-all shadow-sm"
          >
            <svg
              className="w-3.5 h-3.5"
              fill="none"
  ...
  return (
    <div className="space-y-8 pb-20 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-white dark:bg-[#0a0a0a] p-8 rounded-[2.5rem] border border-zinc-200 dark:border-zinc-800 shadow-sm">
        <div>
          <h1 className="text-4xl font-black text-zinc-900 dark:text-white tracking-tighter uppercase mb-1">
            User Directory
          </h1>
          <p className="text-[10px] font-black text-zinc-400 uppercase tracking-[0.3em]">
            Foundry Personnel Management
          </p>
        </div>
                ...
                {[...Array(totalPages)].map((_, i) => {
                  ...
                  if (
                    ...
                    return (
                      <span
                        key={pageNum}
                        className="text-zinc-300 dark:text-zinc-800 text-[10px] px-1 font-black"
                      >
                        ••
                      </span>
                    );
