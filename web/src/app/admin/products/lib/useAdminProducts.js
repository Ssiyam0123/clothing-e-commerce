// src/modules/admin/products/lib/useAdminProducts.js
import {
  useQuery,
  useMutation,
  useQueryClient,
...
export const useAdminProducts = (initialFilters = {}) => {
  ...
  const filters = useMemo(
    () => ({
      ...
      flashSale: searchParams.get("flashSale") || "all",
  ...
  const setFlashSale = useCallback((flashSale) => updateFilters({ flashSale }), [updateFilters]);
